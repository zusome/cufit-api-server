...
import com.official.cufitapi.domain.notification.infrastructure.persistence.NotificationDao
...
class NotificationApi(
    ...
    override fun getNotificationList(
        ...
        val notifications = notificationDao.findAll(authorizationUser.userId)
